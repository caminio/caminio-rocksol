...
module.exports = function SiteGen( caminio ){
  ...
  generator.compilePage = function compilePage( res, webpage, cb ){
    ...
    // the following three functions work like a waterfall
    //
    ...
    function getChildren( arr ){
      ...
      getWebpages( webpage, readyAndRun );
    }

    function readyAndRun( arr ){
    ...
    function createFile( content, translation ){  
