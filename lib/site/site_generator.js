 ...
 * @Last Modified time: 2014-04-29 15:48:52
 *
  ...
  async.eachSeries( object.translations, function( translation, nextTranslation ){
    ...
    gCompileContent( translation.content, options, function( err, compiledContent ){
      ...
      if( options.isPublished )
        paths.push( fileManager.buildAndCleanObjectPath( options.webpage, options.ancestors ) );

      console.log('paths: ', paths, object.translations.length, options.locale );
