...
module.exports = function SiteGen( caminio ){
  ...
  generator.compilePage = function compilePage( res, webpage, params, done ){
    ...
    function generateLocaleContent( translation, cbAfterCompile ){
      ...
      options.webpage.url = function( l, f ){
        WebpageMethods.url.call( webpage, l, f );
      };


      console.log('Before Waterfall', options.webpage.curTranslation)
      async.waterfall(
        [
          getMediaFiles,
          runJSFile,
      ...
      function runJadeCompiler( next ){
        console.log('we are compiling with locale', options.webpage.curTranslation)
