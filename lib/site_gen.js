  ...
  generator.compilePage = function compilePage( res, webpage, done ){
    ...
    function generateSite( err, arr ){
      ...
      function generateLocaleContent( translation, next ){
        ...
        // TODO: do not touch translation.content and remove these dirty lines
        // setting content back to original state
        var origContent = translation.content;
        ...
        async.waterfall(
          ...
          function( err, content ){
            ...
            // TODO: do not touch translation.content and remove these dirty lines
            // setting content back to original state
            translation.content = origContent;
            next();
        });
        ...
        function runJSFile( next ){
           genMethods.runJS( jsFile, options, next );
        }
        ...
        function runPeRuSearch( next ){
          pebbleRubbleSearch.init( translation, domain.getContentPath(), options, next );
        }
