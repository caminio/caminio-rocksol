 ...
 * @Last Modified time: 2014-04-25 13:29:28
 *
...
Dependencies.prototype.getDependenciesOfWebpage = function( webpage, done ){
  ...
  if( 'parent' in webpage.schema.paths ){
...
function setUrlPaths( deps ){
  WebpageMethods.setUrlPath( [ deps.webpage ].concat( deps.siblings ), deps.ancestors );
  WebpageMethods.setUrlPath( deps.children, [ deps.webpage ].concat( deps.ancestors ) );
