 ...
 * @Last Modified time: 2014-04-30 14:54:26
 *
...
module.exports = function( caminio ){
   ...
   */
  funcs.getDependencies = function( object, done ){
   ...
   */
  funcs.getMediafilesOfWebpage = getMediafiles;
   ...
   *  @param cb.err { Object }
   *  @param cb.ancestors { Array } The ancestors of the given webpage starting with the
   *         closest ancestor.
   *  @example
   *  The following example has got two ancestors. The hierarchy is the following:
   *  grandparent/parent/child.
   *
   *      getAncestorsOfWebpage( child, [], function( err, ancestors ){
   *        console.log( ancestors ); // Will print 'parent, grandparent'
   *      })
   *
   */
  funcs.getAncestorsOfWebpage = getAncestors;
   ...
   *  @param cb.ancestors
   */
  funcs.getChildrenOfWebpage = getChildren;
   ...
   */
  funcs.setUrlPathsOfWebpage = setUrlPaths;
