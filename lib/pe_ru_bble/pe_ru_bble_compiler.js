 ...
 * @Last Modified time: 2014-05-26 04:16:33
 *
...
function compileContent( entry ){
  ...
  if( entry.translations &&  entry.translations.length > 0 ){
    var translation = _.find( entry.translations, { 'locale': locale });
    if( !translation )
      translation = _.find( entry.translations, { 'locale': attributes.currentDomain.locale });
    if( !translation )
      throw { 
        name: 'locale_error', 
