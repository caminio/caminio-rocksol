 ...
 * @Last Modified time: 2014-05-03 21:33:45
 *
...
module.exports = function( caminio ){
  ...
  function compileTranslations( object, options, callback ){
    ...
    async.eachSeries( object.translations, function( translation, nextTranslation ){
      ...
      console.log('before gcompilecontent', options.locals.doc._curLang, options.locals.doc.curTranslation.locale );
      
      gCompileContent( translation.content, options, function( err, compiledContent ){

        console.log('after compile content', translation.title, options.locale, options.locals.doc.curTranslation.locale );
        ...
        // no longer required since apache configuration handles languages
        //
        // if( object.layout && (
        //   ( typeof(object.layout) === 'string' && object.layout === 'index') || object.layout.name === 'index' ) )
  ...
  function gCompileContent( content, options, callback ){
    ...
    console.log('compile', options.locals.doc.filename, options.locale, options.locals.doc.curTranslation.locale );
