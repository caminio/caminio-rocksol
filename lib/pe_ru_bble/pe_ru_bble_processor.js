 ...
 * @Last Modified time: 2014-04-15 13:28:01
 *
 ...
 *  @class PeRuCompiler
 */
function PeRuProcessor( caminio, path ){
  db = new PebbleDb( caminio );
  webpageMethods = require('./../webpage_methods')( caminio );
  contentPath = path;
}

PeRuProcessor.prototype.startSearch = function( attributes, done ){
  globalContent = attributes.translation.content;
